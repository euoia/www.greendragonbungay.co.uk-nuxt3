<template>
  ...
  >
    <gd-section
      ...
      :images="[
        {
          src: '/images/front-of-pub.jpg',
          alt: 'Front of the Green Dragon, circa 2023',
        },
        {
          src: '/images/pen-drawing-of-pub.jpg',
    ...
    >
      ...
      >
      <gd-p
        >Our beer is now brewed by our fantastic head brewery, Luke Pawsey,
    ...
    >
      ...
      >
      <gd-p
        >Our brewery produces 7 brewer's barrels (around 1,150 litres) each
        brew. We typically brew 3 times each month. The process takes around 7
        days from soaking the grain to putting into cask. Once in cask the beer
        undergoes secondary fermentation for a minimum of 7 days, after which
        time it can be racked in preparation for serving.</gd-p
      >
      <gd-p
